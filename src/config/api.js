const KEY = '285bff2eed071516fdc21ff0955282e1'
const BASE_URL = 'https://api.themoviedb.org/3'
const requests = {
    fetchTrending : `${BASE_URL}/trending/all/week?api_key=${KEY}&language=en-US`,
    fetchNextflixOriginals : `${BASE_URL}/discover/tv?api_key=${KEY}&with_networks=213`,
    fetchTopRated: `${BASE_URL}/movie/top_rated?api_key=${KEY}&language=en-US`,
    ...
    fetchDocumentaries: `${BASE_URL}/discover/movie?api_key=${KEY}&with_genres=99`,
}
